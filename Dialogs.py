...
class CustomDialog(QDialog):
    def __init__(self, parent_width, parent_height, type, game_sounds):
        ...
        self.setProperty("class", "dialogWindow")
        ...
        match type:
            ...
            case "Color_error":
                self.message.setPlainText("""Выбранный цвет слишком близок к цвету фишек, фона, не закрашенных ячеек или цвету граней шестиугольников. Игровое поле может стать нечитаемым. Продолжить?""")
